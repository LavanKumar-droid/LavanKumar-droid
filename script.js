const COMMANDS = {
  ...
  skills:
    '<span class="code">Languages:</span> Python, JavaScript, HTML, CSS<br><span class="code">Technical:</span>Network Penetration Testing, Web Application Pentesting, API Security Testing, Kali Linux, Vulnerability Assessment, Reverse Engineering, Content Writing<br><span class="code">Tools:</span> Kali,Metasploit Framework, Nmap, Burpsuite, Nikto, Wireshark, Vega, Maltego, Shodan, Ollydbg, OWASP ZAP',
  edu:
